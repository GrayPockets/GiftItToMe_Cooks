				...
				if (giftingUnit ~= nil and GetLevyTurnsRemaining(giftingUnit) == -1) then
					...
					if (not MustPayForGifting() or (MustPayForGifting() and CanPayForGifting())) then
						...
						if ((giftingUnitFormationClass == "FORMATION_CLASS_LAND_COMBAT" and recipientPlayer:IsMajor()) or																			-- Major civs get all kind of combat units
							...
							(giftingUnitType == "UNIT_NATURALIST" and recipientPlayer:IsMajor()) or -- Gathering Storm Civilian
							(giftingUnitType == "UNIT_ROCK_BAND" and recipientPlayer:IsMajor()) or -- Gathering Storm Civilian
							giftingUintType == "UNIT_RURCOM_FARMER" or -- City-Lights Builder
							giftingUintType == "UNIT_RURCOM_MINER" or -- City-Lights Builder
							giftingUintType == "UNIT_RURCOM_FISHER" or -- City-Lights Builder
							(giftingUnitType == "UNIT_LEU_TYCOON" and recipientPlayer:IsMajor()) or -- Monopoly++
							(giftingUnitType == "UNIT_LEU_INVESTOR" and recipientPlayer:IsMajor()) or -- Monopoly++
